...
3. SOURCE CODE
  - tb/riscv_top_tb.v (6.0 KB) - Testbench (non-self-checking)
   - run_sim.sh (3.2 KB) - Automated simulation script
...
MANUAL COMPILATION & EXECUTION:
  $ cd <project_root>/FLOW/RISC-V/CorrectM
