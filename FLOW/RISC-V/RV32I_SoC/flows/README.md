...
- `prjxray-db` is required for Xilinx device synthesis (install separately or configure in build scripts)
- `prjtrellis` sources are required for ECP5 flows (install separately or configure in build scripts)
